...
urlpatterns = [
    ...
    # old builds and v1
    path('card-suggested-actions/<str:card>', CardSuggestedActionsAPI.as_view(), name='____card-suggested-actions'),
    path('v1/card-suggested-actions', CardSuggestedActionsAPI_v1.as_view(), name='card-suggested-actions'),
    
    # for old app builds, send dummy data, v1 is the latest one
    path('status-card-metrics', StatusCardMetricAPI.as_view(), name='____status-card-metrics'),
    path('v1/status-card-metrics', StatusCardMetricAPI_v1.as_view(), name='status-card-metrics'),
    ...
    # v1
    path('v1/attacking-skills', AttackingSkillsAPI_v1.as_view(), name='attacking-skills-metrics-v1'),
    
    # videocard defensive skills
    path('videocard-defensive', VideoCardDefensiveAPI.as_view(), name='videocard-defensive-metrics'),
    # v1
    path('v1/videocard-defensive', VideoCardDefensiveAPI_v1.as_view(), name='videocard-defensive-metrics-v1'),
    ...
    # v1
    path('v1/videocard-distributions', VideoCardDistributionsAPI_v1.as_view(), name='videocard-distributions-metrics-v1'),
    
    # GPS Athletic skills
    path('gps-athletic-skills', GPSAthleticSkillsAPI.as_view(), name='gps-athletic-skills-metrics'),
    # v1
    path('v1/gps-athletic-skills', GPSAthleticSkillsAPI_v1.as_view(), name='gps-athletic-skills-metrics-v1'),
    
    # GPS Football abilities
    path('gps-football-abilities', GPSFootballAbilitiesAPI.as_view(), name='gps-football-abilities-metrics'),
    ## v1
    path('v1/gps-football-abilities', GPSFootballAbilitiesAPI_v1.as_view(), name='gps-football-abilities-metrics-v1'),
