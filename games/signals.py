...
def generate_game_meta_data_json(instance, game):
    ...
    # Read player data
    home_team_players_df = pd.read_excel(instance.data_file, sheet_name="Players_137183")
    away_team_players_df = pd.read_excel(instance.data_file, sheet_name="Players_137183_2")
    ...
    sequence_data_df = pd.read_excel(instance.data_file, sheet_name="SequenceData_137183")
    ...
    GameMetaData.objects.update_or_create(
        game=game,
        defaults={'data': overall_outcome}
    )
